...
func NewResendNotifier(apiKey string, fromEmail string, fromName string) *ResendNotifier {
...
func (n *ResendNotifier) SendPaymentLink(ctx context.Context, ownerEmail string, paymentURL string, mailboxID string) error {
