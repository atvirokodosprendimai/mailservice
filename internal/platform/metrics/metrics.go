...
func (r *Registry) Snapshot(window string) map[string]any {
	...
	if r == nil {
		return map[string]any{
			...
			"payment_link_created":                   int64(0),
			"payment_session_lookup":                 int64(0),
			"webhook_verification_failed":            int64(0),
			"discount_rejected":                      int64(0),
			"webhook_received":                       int64(0),
			"webhook_received_subscription_created":  int64(0),
			"webhook_received_transaction_completed": int64(0),
			"webhook_received_subscription_canceled": int64(0),
			"webhook_received_other":                 int64(0),
		}
	}
	...
	return map[string]any{
		...
		"imap_message_fetched":                   r.Counter("imap_message_fetched").Sum24h(),
		...
		"payment_link_created":                   r.Counter("payment_link_created").Sum24h(),
		"payment_session_lookup":                 r.Counter("payment_session_lookup").Sum24h(),
		"webhook_verification_failed":            r.Counter("webhook_verification_failed").Sum24h(),
		"discount_rejected":                      r.Counter("discount_rejected").Sum24h(),
		"webhook_received":                       r.Counter("webhook_received").Sum24h(),
		"webhook_received_subscription_created":  r.Counter("webhook_received_subscription_created").Sum24h(),
		"webhook_received_transaction_completed": r.Counter("webhook_received_transaction_completed").Sum24h(),
		"webhook_received_subscription_canceled": r.Counter("webhook_received_subscription_canceled").Sum24h(),
		"webhook_received_other":                 r.Counter("webhook_received_other").Sum24h(),
	}
}
