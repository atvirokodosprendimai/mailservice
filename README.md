...
Daily product pulse reports are generated by [.github/workflows/pulse.yml](.github/workflows/pulse.yml) and written as markdown artifacts under `docs/pulse-reports/`. The metric source map lives in [.compound-engineering/config.local.yaml](.compound-engineering/config.local.yaml).
